...
import com.example.e_commerce.databinding.FragmentFavoriteProductsBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.uiEffect.onSubscription {
            if(savedInstanceState==null) {
                viewModel.onEvent(ProductUIEvent.OnFavoriteViewCreated(userId))
            }
